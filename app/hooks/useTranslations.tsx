...
const translations: Translations = {
  ...
  liveProject: { es: 'Ver proyecto en vivo', en: 'View live project' },
  githubRepository: { es: 'Repositorio en GitHub', en: 'GitHub repository' },
  viewVideo: { es: 'Ver video', en: 'Watch video' },
  mincytRecognition: { es: 'Reconocimiento MINCYT', en: 'MINCYT Recognition' },
  argentinaGov: { es: 'Argentina.gob.ar', en: 'Argentina.gob.ar' },
  laNacion: { es: 'La Nación', en: 'La Nación' },
